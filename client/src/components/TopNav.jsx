      ...
      <div className="flex items-center gap-4 md:gap-12 flex-1">
        ...
        <div className="relative hidden md:block">
          ...
          <input 
            ...
            className="bg-[#151a28] text-sm text-white placeholder:text-gray-500 border border-white/5 rounded-full pl-10 pr-4 py-2 focus:outline-none focus:border-primary/50 w-80 transition-colors"
          />
        </div>
      </div>
